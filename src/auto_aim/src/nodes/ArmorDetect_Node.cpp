...
private:
    ...
    void serialDataCallback(const SerialData& msg) {
        ...
        current_pitch_ = (-((float)(processed_msg.bullet_angle)) * 120 / 1.8 - 33.0) * M_PI / 180.0; // 测定pitch轴传入数据1.8大约对应30°
...
// #endif
    ...
    void processImage() {
        ...
        if (!frame.empty()) {
            ...
            // serial_communication_->sendData(00, last_yaw_rad_delayed_, false);
