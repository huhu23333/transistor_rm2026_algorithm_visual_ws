...
void RotationMotionModel::update(const ObservedData& observedData) {
    ...
    LinearRegressionResult zResult = simpleLinearRegression(tData, zData);
    center_z = zResult.a;
    center_vz = zResult.b;
...
void RotationMotionModel::fitRotationParameters() {
    ...
    LinearRegressionResult xReg = simpleLinearRegression(tData, xData);
    LinearRegressionResult yReg = simpleLinearRegression(tData, yData);
    LinearRegressionResult zReg = simpleLinearRegression(tData, zData);
    LinearRegressionResult yawReg = simpleLinearRegression(tData, yawData);
