...
class FakeEnv:
    ...
    def __init__(self, center_x=-100, vx=0, center_y=2000, vy=0, center_z=500, vz=0, yaw=0.1, vyaw=0.8*math.pi, r=276, init_time=0):
    ...
    def observeDataWithNoise(self, obs_time):
        obs_x, obs_y, obs_z, obs_yaw = self.observeData(obs_time)
